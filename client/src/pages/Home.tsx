...
export default function Home() {
  return (
    <div className="pt-16">
      ...
      {/* Services Overview */}
      <section className="py-24 bg-dark-800/50 dark:bg-dark-800/50 bg-gray-50">
      ...
      {/* Featured Portfolio */}
      <section className="py-24 bg-dark-900 dark:bg-dark-900 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
                ...
                <div className="gradient-border overflow-hidden">
                  <div className="gradient-border-content">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-300 dark:text-gray-300 text-gray-600 text-sm mb-4">{item.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="glass-effect p-6 rounded-2xl text-center group hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-2 text-white dark:text-white text-gray-900">AI & Machine Learning</h3>
              <p className="text-gray-300 dark:text-gray-300 text-gray-600 text-sm">OpenAI GPT, TensorFlow, PyTorch, Custom ML Models</p>
            </div>
            
            <div className="glass-effect p-6 rounded-2xl text-center group hover:scale-105 transition-all duration-300">
              <div className="text-4xl mb-4">⚡</div>
              <h3 className="text-xl font-bold mb-2 text-white dark:text-white text-gray-900">Cloud Platforms</h3>
              <p className="text-gray-300 dark:text-gray-300 text-gray-600 text-sm">AWS, Azure, Google Cloud, Serverless Architecture</p>
            </div>
            
            <div className="glass-effect p-6 rounded-2xl text-center group hover:scale-105 transition-all duration-300">
              <div className="text-4xl mb-4">💻</div>
              <h3 className="text-xl font-bold mb-2 text-white dark:text-white text-gray-900">Web Development</h3>
              <p className="text-gray-300 dark:text-gray-300 text-gray-600 text-sm">React, Next.js, Node.js, TypeScript, Modern Frameworks</p>
            </div>
            
            <div className="glass-effect p-6 rounded-2xl text-center group hover:scale-105 transition-all duration-300">
              <div className="text-4xl mb-4">🔒</div>
              <h3 className="text-xl font-bold mb-2 text-white dark:text-white text-gray-900">Security & Analytics</h3>
              <p className="text-gray-300 dark:text-gray-300 text-gray-600 text-sm">Enterprise Security, Real-time Analytics, Data Protection</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-white dark:text-white text-gray-900">Proven Methodology</h3>
                    <p className="text-gray-300 dark:text-gray-300 text-gray-600">Our systematic approach ensures consistent, high-quality results with 98% client satisfaction rate.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-white dark:text-white text-gray-900">Rapid Implementation</h3>
                    <p className="text-gray-300 dark:text-gray-300 text-gray-600">Fast deployment with 40% faster time-to-market using agile methodologies and modern DevOps practices.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-white dark:text-white text-gray-900">Ongoing Support</h3>
                    <p className="text-gray-300 dark:text-gray-300 text-gray-600">24/7 monitoring and continuous optimization to ensure your solutions evolve with your business needs.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 glass-effect p-4 rounded-xl">
                ...
                <div className="text-sm text-gray-300 dark:text-gray-300 text-gray-600">Projects Delivered</div>
              </div>
            </div>
          </div>
        </div>
